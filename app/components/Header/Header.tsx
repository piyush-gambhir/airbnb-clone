    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-row gap-6 items-center px-20 py-8">
        <div className="flex flex-row gap-10">
          {HEADER_DATA?.filterCategories?.slice(0, 13).map((item) => (
            <div className="flex flex-col gap-4 px-1 text-center items-center justify-top whitespace-nowrap cursor-pointer select-none">
              <img
                className=""
                src={item.icon}
                width={24}
